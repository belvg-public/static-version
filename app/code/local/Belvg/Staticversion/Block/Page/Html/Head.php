...
class Belvg_Staticversion_Block_Page_Html_Head extends Mage_Page_Block_Html_Head
{
    /**
    ...
    protected function &_prepareStaticAndSkinElements($format, array $staticItems, array $skinItems, $mergeCallback = null)
    {
        ...
        foreach ($items as $params => $rows) {
            ...
            if ($mergedUrl) {
                ...
                //BelVG Start
                if(Mage::helper('staticversion')->isEnabled()) {
                    $mergedUrl .= '?ver=' . Mage::helper('staticversion')->getVersion();
                }
                //BelVG End
                ...
                foreach ($rows as $src) {
                    ...
                    //BelVG Start
                    if(Mage::helper('staticversion')->isEnabled()) {
                        $src .= '?ver=' . Mage::helper('staticversion')->getVersion();
                    }
                    //BelVG End
